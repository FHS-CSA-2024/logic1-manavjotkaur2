...
public class Logic1
{
    ...
    public boolean answerCell(boolean isMorning, boolean isMom, boolean isAsleep) {
      ...
      else if(isMorning==true || isAsleep==true){
          return false;
      }
      else{
          return false;
    ...
    public boolean squirrelPlay(int temp, boolean isSummer) {
      ...
      else if(isSummer == false && 60<temp && temp<90){
          return true;
      }
      else{
          return false;
    ...
    public int caughtSpeeding(int speed, boolean isBirthday) {
      ...
      else if(isBirthday==false && speed<60){
          return 0;
      }
      else if(isBirthday==false && 61<speed && speed<80){
          return 1;
      }
      else if(isBirthday==false && speed>80){
          return 2;
      }
      else{
          return 0;
    ...
    public boolean sodaParty(int sodas, boolean isWeekend) {
      if(isWeekend == false && 40<sodas && sodas<60){
          return true;
      }
      else if(isWeekend == true && sodas>60){
          return true;
      }
      else{
          return false;
